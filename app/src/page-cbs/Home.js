...
export function useButton34Cb() {
	const onClick = useCallback(callbackFactory("Button34", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useInput12Cb() {
	const onChange = useCallback(callbackFactory("Input12", "Home", "/", "onChange", 
			{
  "handlers": [],
  "actions": [
    {
	...
	const onPressEnter = useCallback(callbackFactory("Input12", "Home", "/", "onPressEnter", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useButton37Cb() {
	const onClick = useCallback(callbackFactory("Button37", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useButton38Cb() {
	const onClick = useCallback(callbackFactory("Button38", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
